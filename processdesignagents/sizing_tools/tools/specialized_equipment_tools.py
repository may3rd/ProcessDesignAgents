...
def size_knockout_drum_basic(
    ...
    """
    Preliminary knockout drum sizing to separate entrained liquids from vapor streams.
    """
...
def size_filter_vessel_basic(
    ...
    """
    Preliminary filter vessel sizing estimating media area and vessel envelope.
    """
    return equipment_sizing(
...
def size_dryer_vessel_basic(
    ...
    """
    Preliminary dryer vessel sizing for adsorption dryers, including bed volume and regeneration duty.
    """
    return equipment_sizing(
        "dryer_vessel_sizing",
        gas_flow_kmol_h,
