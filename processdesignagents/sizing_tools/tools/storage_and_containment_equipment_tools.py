...
def size_storage_tank_basic(
    ...
    """
    Preliminary storage tank sizing covering geometry, thickness, and roof selection.
    """
...
def size_surge_drum_basic(
    ...
    """
    Preliminary surge drum sizing focused on holdup volume and drum geometry.
    """
    return equipment_sizing(
        "surge_drum_sizing",
        inlet_flow_kg_h,
