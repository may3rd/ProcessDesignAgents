...
def size_heat_exchanger_basic(
    ...
    return equipment_sizing(
        ...
        heat_exchanger_data, hot_stream,
        cold_stream
        )

@tool
def size_shell_and_tube_heat_exchanger(
    shell_and_tube_heat_exchanger_data: Annotated[Dict, {}],
    hot_stream: Annotated[Dict, {}],
    cold_stream: Annotated[Dict, {}]
) -> str:
    """
    ...
    Agrs:
        shell_and_tube_heat_exchanger_sizing (Dict): the information of shell and tube heat exchanger extracted from equipment list
        hot_stream (Dict): hot stream data
        cold_stream (Dict): cold stream data
    Returns:
        str: An update equipment sizing in JSON format.
    ...
    return equipment_sizing(
        ...
        shell_and_tube_heat_exchanger_data,
