...
class GraphSetup:
    ...
    def setup_graph(
        ...
        graph.add_node("stream_data_builder", stream_data_builder)
        ...
        graph.add_edge("basic_pdf_designer", "stream_data_builder")
        graph.add_edge("stream_data_builder", "process_simulator")
        graph.add_edge("process_simulator", "equipment_list_builder")
