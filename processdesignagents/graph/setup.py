...
class GraphSetup:
    ...
    def setup_graph(
        ...
        stream_data_estimator = self._wrap_with_delay(create_stream_data_estimator(self.quick_thinking_llm))
        equipment_sizing_agent = self._wrap_with_delay(create_equipment_sizing_agent(self.quick_thinking_llm))
        ...
        graph.add_edge("stream_data_estimator", "equipment_sizing_agent")
