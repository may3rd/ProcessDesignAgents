...
def format_streams_to_markdown(streams: list[Stream], streams_per_table: int = 10) -> str:
    ...
    for i in range(0, len(streams), streams_per_table):
        ...
        # Sort component names for consistent order
        sorted_component_names = sorted(list(all_component_names))
...
def convert_to_markdown(data: EquipmentsAndStreamsListBuilder, streams_per_table: int = 10) -> str:
    """
