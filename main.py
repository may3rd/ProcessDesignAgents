...
async def main():
    ...
    problem_statement = "design MWCNT production, CVD of Methane in Fludized Bed Reactor, feed stock is LNG with 93% mole Methane (do need feed vaporization), the by-product H2 generated will be collected to be blue hydrogen. Target capacity is 200 Ton per year of CNT production."
    ...
    result = await graph.propagate(problem_statement=problem_statement, save_markdown="reports/latest_run.md")
    # print(result)
