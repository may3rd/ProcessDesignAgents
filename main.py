...
async def main():
    ...
    # problem_statement = "design MWCNT production, CVD of Methane in Fludized Bed Reactor, feed stock is LNG with 93% mole Methane, the by-product H2 generated will be collected to be blue hydrogen. Target capacity is 37 kg/h of CNT production."
