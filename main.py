...
def main():
    ...
    problem_statement = "design the carbon capture modular package, the feed to the package can be flue gas from various burner type. The target CO2 purity is 99.5% with 10-100 Ton CO2 per day capacity"
    problem_statement = "design heat exchanger to cool the ethanol product (99.5% purity molar basis, impurity is water) from 100°C to 50°C. Design flowrate of ethanol feed is 2500 kg/hr. Supply CW temp is 30°C and return temp is 40°C."
